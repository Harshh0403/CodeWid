    ...
    return (
        ...
        >
            ...
            <div className="flex h-[90%] w-full flex-col items-end gap-2 md:h-[92%]">
                ...
                />
                <button
                    className="flex w-full justify-center rounded-md bg-[#42b1b7] hover:bg-[#369ea2] p-2 font-bold text-black outline-none disabled:cursor-not-allowed disabled:opacity-50"
                    onClick={runCode}
                    disabled={isRunning}
                >
                    Run
