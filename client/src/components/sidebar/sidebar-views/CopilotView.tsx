...
function CopilotView() {
    ...
    return (
        ...
        >
            ...
            />
            <button
            className="mt-1 flex w-full justify-center rounded-md p-2 font-bold text-black outline-none disabled:cursor-not-allowed disabled:opacity-50"
            style={{ backgroundColor: "#42b1b7" }}
